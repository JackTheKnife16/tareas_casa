...
port_config_file = "qs_1_0/config/front_plane_config/52x2.5G.json"
...
subcomp_traffic_profile = comp_packet_generator.setSubComponent("traffic_profile", "TRAFFIC_GEN_1_0.PhaseOne", 0)
