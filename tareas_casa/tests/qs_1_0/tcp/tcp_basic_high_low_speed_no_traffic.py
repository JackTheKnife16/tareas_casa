...
traffic_config_file = "tests/qs_1_0/tcp/traffic_config/traffic_config_high_low_speed_no_traffic.json"
...
# TCP model
host48 = sst.Component("host48", "networkTraffic.NetworkHost")
host48.addParams({
    "ip_address": "10.0.0.2",
    "mac_address": "BE:EF:FF:FF:FF:FF",
    "network_table": "tests/qs_1_0/tcp/network_table_high_low_speed.json",
    "priority": 2,
    "verbose" : verbosity_option,
})
sch48 = host48.setSubComponent("event_scheduler", "networkTraffic.EventScheduler", 0)
sch48.addParams({
    "verbose" : verbosity_option,
})

# Host 0 Port -----------
port48 = sst.Component("port48", "networkTraffic.NetworkPort")
port48.addParams({
    "number": 48,
    "verbose" : verbosity_option,
})
...
# Physical
phys48 = host48.setSubComponent("physical", "networkTraffic.PhysicalLayer", 0)
phys48.addParams({
    "host_bandwidth": "10Gb/s",
    "verbose" : verbosity_option,
})

# Data Link
dlink48 = host48.setSubComponent("data_link", "networkTraffic.EthernetDataLinkLayer", 0)
dlink48.addParams({
    "dot1q": 0,
    "verbose" : verbosity_option,
})
...
# Network
net48 = host48.setSubComponent("network", "networkTraffic.IpNetworkLayer", 0)
net48.addParams({
    "ipv6": 0,
    "verbose" : verbosity_option,
})
...
# Transport
transp48 = host48.setSubComponent("transport", "networkTraffic.TCPTransportLayer", 0)
transp48.addParams({
    "verbose" : verbosity_option,
})

# Applications
transmitter = host48.setSubComponent("applications", "networkTraffic.BasicTransmitter", 0)
...
link_port_physical_0.connect(
    (phys48, "network_port", "10ps"),
    (port48, "physical_connection", "10ps"),
)
