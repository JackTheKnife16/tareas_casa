...
traffic_config_file = "tests/qs_1_0/tcp/traffic_config/traffic_config_host_traffic.json"
# Loading ports config file
...
comp_egress_ports[0].enableStatistics(
    ["bytes_sent_by_port"],
    {
        "type":"sst.AccumulatorStatistic",
        "rate": "1 event",
...
for egress_port in egress_ports_receiving_traffic:
    ...
    # Source port being serviced stat
    comp_schedulers[egress_port].enableStatistics(
        ["source_serviced"],
        {
            "type":"sst.AccumulatorStatistic",
