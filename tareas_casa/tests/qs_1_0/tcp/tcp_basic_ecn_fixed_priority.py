...
parser.add_argument('-e', '--ecn', required=False,
                    help="Path to ECN config file.")
...
# ECN config file
ecn_file = "qs_1_0/config/ecn_config/ecn_config.json"
if args.ecn:
    ecn_file = args.ecn
...
traffic_config_file = "tests/qs_1_0/tcp/traffic_config/traffic_config_basic_ecn_fixed_pri.json"
# Loading ports config file
